...
<sub>📡 Last transmission: <b>2026-09-04 20:27 UTC</b> &nbsp;·&nbsp; Source: <a href="https://opensky-network.org">OpenSky Network</a> (free, no API key) &nbsp;·&nbsp; Refreshed every 3 h by GitHub Actions.</sub>
<!-- FLIGHT-DATA:END -->
